...
static rosidl_typesupport_introspection_c__MessageMember apriltag_msgs__msg__AprilTagDetection__rosidl_typesupport_introspection_c__AprilTagDetection_message_member_array[4] = {
  {
    "family",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, apriltag_msgs, msg, AprilTagDetection)() {
  apriltag_msgs__msg__AprilTagDetection__rosidl_typesupport_introspection_c__AprilTagDetection_message_member_array[3].members_ =
